...
public class PrimordialCosmicOriginCore extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialCosmicOriginCore(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialCosmicOriginCoreLogic createRecipeLogic(Object... args) {
        return new PrimordialCosmicOriginCoreLogic(this);
    }

    @Override
    public PrimordialCosmicOriginCoreLogic getRecipeLogic() {
        return (PrimordialCosmicOriginCoreLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_cosmic_origin_core.mode").withStyle(ChatFormatting.GREEN));
        } else {
            textList.add(Component.translatable("gtceu.multiblock.invalid_structure").withStyle(ChatFormatting.RED));
        }
        textList.add(Component.translatable("gt_shanhai.machine.primordial_cosmic_origin_core.name").withStyle(ChatFormatting.GOLD));
    }
}
