...
public class PrimordialSingularityInversionCore extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialSingularityInversionCore(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialSingularityInversionCoreLogic createRecipeLogic(Object... args) {
        return new PrimordialSingularityInversionCoreLogic(this);
    }

    @Override
    public PrimordialSingularityInversionCoreLogic getRecipeLogic() {
        return (PrimordialSingularityInversionCoreLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (!canModuleWork()) {
                textList.add(Component.translatable("gt_shanhai.machine.primordial_singularity_inversion_core.name")
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_singularity_inversion_core.mode")
