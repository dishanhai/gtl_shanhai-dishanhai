...
public class PrimordialMatterCasterStructure {
    ...
    public static BlockPattern createPattern(MultiblockMachineDefinition definition) {
        ...
        return MultiBlockStructure.INSTANCE.getFORGE_OF_THE_ANTICHRIST_MODULE()
                .where('A', blocks)
                .where('B', blocks.or(Predicates.abilities(PartAbility.IMPORT_ITEMS).setPreviewCount(1))
    ...
    private PrimordialMatterCasterStructure() {}
}
