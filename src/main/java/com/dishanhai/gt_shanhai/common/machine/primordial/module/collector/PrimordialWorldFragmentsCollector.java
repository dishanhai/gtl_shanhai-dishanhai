...
public class PrimordialWorldFragmentsCollector extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialWorldFragmentsCollector(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialWorldFragmentsCollectorLogic createRecipeLogic(Object... args) {
        return new PrimordialWorldFragmentsCollectorLogic(this);
    }

    @Override
    public PrimordialWorldFragmentsCollectorLogic getRecipeLogic() {
        return (PrimordialWorldFragmentsCollectorLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (!canModuleWork()) {
                textList.add(Component.translatable("gt_shanhai.machine.primordial_world_fragments_collector.name")
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_world_fragments_collector.mode")
