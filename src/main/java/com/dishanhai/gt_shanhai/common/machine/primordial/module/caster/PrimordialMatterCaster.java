package com.dishanhai.gt_shanhai.common.machine.primordial.module.caster;
...
public class PrimordialMatterCaster extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialMatterCaster(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialMatterCasterLogic createRecipeLogic(Object... args) {
        return new PrimordialMatterCasterLogic(this);
    }

    @Override
    public PrimordialMatterCasterLogic getRecipeLogic() {
        return (PrimordialMatterCasterLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_matter_caster.mode").withStyle(ChatFormatting.GREEN));
        } else {
            textList.add(Component.translatable("gtceu.multiblock.invalid_structure").withStyle(ChatFormatting.RED));
        }
        textList.add(Component.translatable("gt_shanhai.machine.primordial_matter_caster.name").withStyle(ChatFormatting.GOLD));
    }
}
