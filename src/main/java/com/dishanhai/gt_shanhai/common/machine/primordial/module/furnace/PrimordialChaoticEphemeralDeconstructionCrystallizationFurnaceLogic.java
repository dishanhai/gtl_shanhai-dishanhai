...
public class PrimordialChaoticEphemeralDeconstructionCrystallizationFurnaceLogic extends PrimordialModuleRecipeLogic {
    public PrimordialChaoticEphemeralDeconstructionCrystallizationFurnaceLogic(GTLAddWirelessWorkableElectricMultipleRecipesMachine machine) {
        super(machine);
    }
}
