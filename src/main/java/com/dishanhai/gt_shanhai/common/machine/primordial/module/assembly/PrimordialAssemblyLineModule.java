...
public class PrimordialAssemblyLineModule extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialAssemblyLineModule(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialAssemblyLineModuleLogic createRecipeLogic(Object... args) {
        return new PrimordialAssemblyLineModuleLogic(this);
    }

    @Override
    public PrimordialAssemblyLineModuleLogic getRecipeLogic() {
        return (PrimordialAssemblyLineModuleLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (!canModuleWork()) {
                textList.add(Component.translatable("gt_shanhai.machine.primordial_assembly_line_module.name")
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_assembly_line_module.mode")
