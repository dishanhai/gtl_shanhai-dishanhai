 ...
 *
 * 安装在运行中的原初引擎上才能工作。
 * 支持电炉 / 合金冶炼 / 电力高炉 / 合金冶炼炉 / 太虚熔炼。
 * 通过模块物品槽调节并行数。
 */
public class PrimordialTaixuCosmicForgeModule extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialTaixuCosmicForgeModule(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (!canModuleWork()) {
                textList.add(Component.translatable("machine.taixu_smelting_furnace.name")
            ...
            textList.add(Component.translatable("gt_shanhai.machine.taixu_smelting_furnace.mode")
