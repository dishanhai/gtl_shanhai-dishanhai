...
public class PrimordialAbyssalRefinery extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialAbyssalRefinery(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialAbyssalRefineryLogic createRecipeLogic(Object... args) {
        return new PrimordialAbyssalRefineryLogic(this);
    }

    @Override
    public PrimordialAbyssalRefineryLogic getRecipeLogic() {
        return (PrimordialAbyssalRefineryLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_abyssal_refinery.mode").withStyle(ChatFormatting.GREEN));
        } else {
            textList.add(Component.translatable("gtceu.multiblock.invalid_structure").withStyle(ChatFormatting.RED));
        }
        textList.add(Component.translatable("gt_shanhai.machine.primordial_abyssal_refinery.name").withStyle(ChatFormatting.GOLD));
    }
}
