...
public class PrimordialChaoticEphemeralDeconstructionCrystallizationFurnace extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialChaoticEphemeralDeconstructionCrystallizationFurnace(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialChaoticEphemeralDeconstructionCrystallizationFurnaceLogic createRecipeLogic(Object... args) {
        return new PrimordialChaoticEphemeralDeconstructionCrystallizationFurnaceLogic(this);
    }

    @Override
    public PrimordialChaoticEphemeralDeconstructionCrystallizationFurnaceLogic getRecipeLogic() {
        return (PrimordialChaoticEphemeralDeconstructionCrystallizationFurnaceLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_chaotic_ephemeral_deconstruction_crystallization_furnace.mode").withStyle(ChatFormatting.GREEN));
        } else {
            textList.add(Component.translatable("gtceu.multiblock.invalid_structure").withStyle(ChatFormatting.RED));
        }
        textList.add(Component.translatable("gt_shanhai.machine.primordial_chaotic_ephemeral_deconstruction_crystallization_furnace.name").withStyle(ChatFormatting.GOLD));
    }
}
