...
public class PrimordialCausalWeavingMatrix extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialCausalWeavingMatrix(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialCausalWeavingMatrixLogic createRecipeLogic(Object... args) {
        return new PrimordialCausalWeavingMatrixLogic(this);
    }

    @Override
    public PrimordialCausalWeavingMatrixLogic getRecipeLogic() {
        return (PrimordialCausalWeavingMatrixLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (!canModuleWork()) {
                textList.add(Component.translatable("gt_shanhai.machine.primordial_causal_weaving_matrix.name")
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_causal_weaving_matrix.mode")
