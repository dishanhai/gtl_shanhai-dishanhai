...
public class PrimordialAntiEntropyCondensationCore extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialAntiEntropyCondensationCore(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialAntiEntropyCondensationCoreLogic createRecipeLogic(Object... args) {
        return new PrimordialAntiEntropyCondensationCoreLogic(this);
    }

    @Override
    public PrimordialAntiEntropyCondensationCoreLogic getRecipeLogic() {
        return (PrimordialAntiEntropyCondensationCoreLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            if (!canModuleWork()) {
                textList.add(Component.translatable("gt_shanhai.machine.primordial_anti_entropy_condensation_core.name")
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_anti_entropy_condensation_core.mode")
