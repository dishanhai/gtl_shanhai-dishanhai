...
public class PrimordialCosmicOriginCoreLogic extends PrimordialModuleRecipeLogic {
    public PrimordialCosmicOriginCoreLogic(GTLAddWirelessWorkableElectricMultipleRecipesMachine machine) {
        super(machine);
    }
}
