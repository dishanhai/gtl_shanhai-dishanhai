...
public class PrimordialDivergenceGenerator extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialDivergenceGenerator(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialDivergenceGeneratorLogic createRecipeLogic(Object... args) {
        return new PrimordialDivergenceGeneratorLogic(this);
    }

    @Override
    public PrimordialDivergenceGeneratorLogic getRecipeLogic() {
        return (PrimordialDivergenceGeneratorLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_divergence_generator.mode").withStyle(ChatFormatting.GREEN));
        } else {
            textList.add(Component.translatable("gtceu.multiblock.invalid_structure").withStyle(ChatFormatting.RED));
        }
        textList.add(Component.translatable("gt_shanhai.machine.primordial_divergence_generator.name").withStyle(ChatFormatting.GOLD));
    }
}
