...
public class PrimordialFlameCrackingKiln extends PrimordialOmegaEngineModuleBase {
    ...
    public PrimordialFlameCrackingKiln(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    ...
    @Override
    public PrimordialFlameCrackingKilnLogic createRecipeLogic(Object... args) {
        return new PrimordialFlameCrackingKilnLogic(this);
    }

    @Override
    public PrimordialFlameCrackingKilnLogic getRecipeLogic() {
        return (PrimordialFlameCrackingKilnLogic) recipeLogic;
    }
    ...
    public void addDisplayText(List<Component> textList) {
        if (isFormed()) {
            ...
            textList.add(Component.translatable("gt_shanhai.machine.primordial_flame_cracking_kiln.mode").withStyle(ChatFormatting.GREEN));
        } else {
            textList.add(Component.translatable("gtceu.multiblock.invalid_structure").withStyle(ChatFormatting.RED));
        }
        textList.add(Component.translatable("gt_shanhai.machine.primordial_flame_cracking_kiln.name").withStyle(ChatFormatting.GOLD));
    }
}
