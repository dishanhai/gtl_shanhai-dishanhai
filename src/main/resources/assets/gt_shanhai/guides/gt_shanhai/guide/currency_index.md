...
item_ids:
  - dishanhai:dog_coins
  - dishanhai:copper_coin
  - dishanhai:cupronickel_coin
  - dishanhai:silver_coin
  - dishanhai:gold_coin
  - dishanhai:platinum_coin
...
> 这一页收纳山海里所有用于兑换、结算和任务交付的货币说明。\
> 它们不是普通材料，也不是库存仓位，而是一套专门服务于 FTBQ 任务兑换、终局奖励发放和特殊流程结算的独立物品体系。\
> 货币本体由 KJS 在 `startup_scripts/山海的物品注册.js` 统一注册。
...
> 下面这些就是当前已经注册的货币物品。\
> 它们都由 `startup_scripts/山海的物品注册.js` 注册，图鉴里看到的就是这份名单。

#### 基础货币

* <ItemLink id="dishanhai:dog_coins" />：Doge币
* <ItemLink id="dishanhai:copper_coin" />：铜GT币
* <ItemLink id="dishanhai:cupronickel_coin" />：白铜GT币
* <ItemLink id="dishanhai:silver_coin" />：银GT币
* <ItemLink id="dishanhai:gold_coin" />：金GT币
* <ItemLink id="dishanhai:platinum_coin" />：铂GT币
...
> 如果你在找“图鉴里能兑换什么”，就按上面这份清单认。\
> 如果你在找“怎么获得”，再去看原初铸币工厂或 FTBQ 任务自动化。
...
* 想看铸币入口，去 [原初铸币工厂](machine/primordial_coin_forge.md)。
* 想看任务自动交付，去 [FTBQ 任务自动化](ae/ftbq_index.md)。
* 如果只是想确认某个货币是不是“材料”，答案通常是否定的，它更接近一种统一的结算凭证。
