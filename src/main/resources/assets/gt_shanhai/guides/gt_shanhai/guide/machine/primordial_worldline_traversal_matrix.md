...
## 配方类型
* `gtceu:magic_manufacturer`：魔力生成。
* `gtceu:space_cosmic_probe_receivers`：天基宇宙探测。
* `gtceu:decay_hastener`：衰变加速。
* `gtceu:neutron_activator`：中子活化。
* `gtceu:bedrock_drilling_rig`：基岩钻机。
